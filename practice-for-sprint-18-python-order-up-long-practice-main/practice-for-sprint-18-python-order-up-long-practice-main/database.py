...
with app.app_context():
    ...
    table1= Table(number=1, capacity=5)
    table2= Table(number=2, capacity=5)
    table3= Table(number=3, capacity=5)
    table4= Table(number=4, capacity=5)
    ...
    db.session.add_all([employee, beverages, entrees, sides, dinner, fries, drp, jambalaya,table1,table2,table3,table4,table5,table6,table7,table8,table9])
    db.session.commit()
